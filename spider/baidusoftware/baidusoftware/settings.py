...
BOT_NAME = 'baidusoftware'

SPIDER_MODULES = ['baidusoftware.spiders']
NEWSPIDER_MODULE = 'baidusoftware.spiders'
...
ITEM_PIPELINES = {
    'baidusoftware.pipelines.MysqlStorePipeline': 100,
}
...
# DOWNLOADER_MIDDLEWARES = {
    # 'baidusoftware.pipelines.WebkitDownloader': 551
# }
